...
import homeAboutSectionRoutes from './routes/homeAboutSectionRoutes.js';
import gallerySectionRoutes from './routes/gallerySectionRoutes.js';
...
app.use('/api/home-about-section', homeAboutSectionRoutes);
app.use('/api/gallery-section', gallerySectionRoutes);
